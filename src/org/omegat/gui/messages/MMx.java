...
class MMx implements Runnable
{
	...
	private TransFrameInterface m_tf;

	public MMx(TransFrameInterface tf, int cmd)
	{
		m_cmdNum = 0;
		m_tf = tf;
	...
	public MMx(TransFrameInterface tf, int cmd, String msg)
	{
		m_cmdNum = 0;
		m_tf = tf;
	...
	public MMx(TransFrameInterface tf, String msg, Throwable e)
	{
		m_cmdNum = 0;
		m_tf = tf;
        int cmd = 9;
